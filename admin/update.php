   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <p>Faculty </p>
            <input type="text" name="faculty" placeholder="<?= $fetch_profile['faculty']; ?>" maxlength="50"  class="box">
            <p>University </p>
            <input type="text" name="university" placeholder="<?= $fetch_profile['university']; ?>" maxlength="50"  class="box">           
         </div>
         <div class="col">
            <p>Old password :</p>
